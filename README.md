...
- **🏛️ Room Management**: Manage Lecture halls and Laboratories along with their seating capacities.
...
- **👁️ Dynamic Timetable Views**: View generated schedules by Section, Faculty/TA, or Room.
- **📊 CSV Export**: One-click export for tailored schedules.
- **⚠️ Conflict Reporting**: Visual feedback on scheduling bottlenecks.
...
To access the dashboard for the first time, use the following default credentials (or update them directly in your database/seeder):
...
## 🙏 Acknowledgements
This project was developed as part of a final-year academic/college project. Special thanks to the faculty and mentors who provided the structural guidelines and constraint requirements for university course scheduling.
